...
![Image](Cat3.png)
- No arguments
  - The "cat" command was executed on the home directory. The output was blank, but no error showed. Anything you type in the terminal, it will be returned as an output. To exit that mode, you need to use control(^) + c.
- Directory as an argument
